...
import static org.video_player.PlayManager2.PlayStatus.ERROR;
import static org.video_player.PlayManager2.PlayStatus.NORMAL;
import static org.video_player.PlayManager2.PlayStatus.PAUSE;
import static org.video_player.PlayManager2.PlayStatus.PLAYING;
...
public class VideoPlayer2 extends RelativeLayout {
    ...
    protected PlayManager2 mManager;
    protected PlayManager2.PlayListener mPlayListener;
    ...
    protected void init() {
        ...
        mManager = PlayManager2.getInstance(getContext());
        findViews();
        setListeners();
    ...
    protected void setListeners() {
        OnClickListener onClickListener = new OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isFullScreenNow) {
                    mManager.setCurrentPlayer(VideoPlayer2.this);
        ...
        mPlayListener = new PlayManager2.PlayListener() {
            @Override
    ...
    static class Status {
        ...
        PlayManager2.PlayStatus lastStatus;
        ...
        PlayManager2.PlayStatus getLastStatus() {
            return lastStatus;
        }

        void setLastStatus(PlayManager2.PlayStatus lastStatus) {
